...
namespace WorkPlanner.DataAccess.Migrations
{
    ...
    [Migration("20240608163257_BugFix")]
            ...
            modelBuilder.Entity("WorkPlanner.Domain.Entities.SprintTask", b =>
                {
                    ...
                    b.ToTable("Tasks", t =>
                        {
                            t.HasCheckConstraint("CK_Task_SprintOrBacklog", "[SprintId] IS NOT NULL AND [BacklogId] IS NULL OR [SprintId] IS NULL AND [BacklogId] IS NOT NULL");
                        });
                });
